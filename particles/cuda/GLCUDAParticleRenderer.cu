...
//
//      GLCUDAParticleRenderer::GLCUDAParticleRenderer(ParticleCollection* particlesArray)
...
//        glBufferSubData(GL_ARRAY_BUFFER, 0, sizeof(GL_FLOAT) * aliveParticles * 4, &renderConfig->particleColors->front());
//
//
//      }
//
