...
//  OSGDefaultParticleSorter::OSGDefaultParticleSorter(ParticleCollection* particlesArray)
//  : ParticleSorter(particlesArray)
//  {
//    distances = new DistanceArray( particlesArray->size );
//  }
//
//  OSGDefaultParticleSorter::~OSGDefaultParticleSorter()
//  {
//
//  }
//
