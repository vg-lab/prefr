...
# Configures the build for a simple cuda-based library:
...
function(CUDA_COMMON_LIBRARY Name)
  ...
  set(CUDA_LIBRARY_OPTIONS ${${NAME}_CUDA_LIBRARY_OPTIONS})
  ...
  file(WRITE ${PROJECT_GENERATED_HEADER}
    "// generated by CudaCommonLibrary.cmake, do not edit\n"
    "#ifndef ${NAME}_H\n"
    "#define ${NAME}_H\n")
  ...
  foreach(LIBRARY_TYPE ${${NAME}_LIBRARY_TYPE})
    ...
    cuda_add_library(${LIBNAME} ${LIBRARY_TYPE} ${SOURCES}
      ${HEADERS} ${PUBLIC_HEADERS} OPTIONS ${CUDA_LIBRARY_OPTIONS})
